...
// Current build
#define	MMFS2_CURRENT_BUILD		239
...
#define SCF_EVENNOCOL		4				// Flag: returns even sprites that haven't the SF_RAMBO flag
#define SCF_BACKGROUND		8				// Flag: if 0, returns active sprites, otherwise returns background sprites
